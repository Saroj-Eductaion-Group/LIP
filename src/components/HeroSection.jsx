          ...
          <div className="space-y-8">
            ...
            >
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                className="px-8 py-4 border-2 border-gray-800 rounded-xl font-bold text-gray-800 hover:bg-gray-800 hover:text-white transition-all flex items-center gap-3"
              >
