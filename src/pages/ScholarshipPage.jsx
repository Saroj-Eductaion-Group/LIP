          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            <div className="bg-white shadow-xl rounded-xl p-6">
              ...
              <p className="text-gray-600 text-xl">
                Lucknow Institute of Pharmacy (LIP) offers generous scholarship opportunities to recognize and reward academic excellence among its students.
              </p>
            </div>
            ...
            <div className="bg-white shadow-xl rounded-xl p-6">
              <div className='flex items-center justify-center mb-4'>
                ...
                <h3 className="text-blue-600 font-semibold text-2xl">Scholarship Criteria</h3>
              </div>
              <p className="text-gray-600 text-xl">
            ...
            <div className="bg-white shadow-xl rounded-xl p-6">
              <div className='flex items-center justify-center mb-4'>
                ...
                <h3 className="text-blue-600 font-semibold text-2xl">Percentage-Based scholarships</h3>
              </div>
              <div className="text-gray-600 space-y-2 text-xl">
                <p>Above 90% - <strong>100%</strong> tuition fee scholarship.</p>
                <p>80%–90% marks - <strong>50%</strong> tuition fee scholarship.</p>
                <p>75%–80% marks - <strong>25%</strong> tuition fee scholarship.</p>
              </div>
            </div>
            ...
            <div className="bg-white shadow-xl rounded-xl p-6">
              <div className='flex items-center justify-center mb-4'>
                ...
                <h3 className="text-blue-600 font-semibold text-2xl">Recognition of Achievement</h3>
              </div>
              <p className="text-gray-600 text-xl">
            ...
            <div className="bg-white shadow-xl rounded-xl p-6">
              <div className='flex items-center justify-center mb-4'>
                ...
                <h3 className="text-blue-600 font-semibold text-2xl">Encouragement for Excellence</h3>
              </div>
              <p className="text-gray-600 text-xl">
            ...
            <div className="bg-white shadow-xl rounded-xl p-6">
              <div className='flex items-center justify-center mb-4'>
                ...
                <h3 className="text-blue-600 font-semibold text-2xl">Accessible Opportunities</h3>
              </div>
              <p className="text-gray-600 text-xl">
                LIP ensures students from all financial backgrounds can access quality education.
              </p>
            </div>
            ...
            <div className="bg-white shadow-xl rounded-xl p-6 md:col-span-2 xl:col-span-3">
              <div className='flex items-center justify-center'>
                <p className="font-medium text-gray-800 text-xl">
                  The scholarship program at Lucknow Institute of Pharmacy reflects a commitment to recognizing talent, fostering excellence, and making education accessible.
                </p>
              </div>
            </div>
          </div>
